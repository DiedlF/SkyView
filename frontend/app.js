...
const LEGEND_CONFIGS = {
  ...
  cloud_base_hourly_max: { title: 'Cloud base max (1h)', gradient: 'linear-gradient(to right, rgb(220,60,60), rgb(240,150,60), rgb(180,220,60), rgb(80,240,80))', labels: ['0m', '5000m'] },
  mh: { title: 'Boundary layer top (MSL)', gradient: 'linear-gradient(to right, rgb(220,90,40), rgb(160,170,60), rgb(80,240,100))', labels: ['0m MSL', '5000m+ MSL'] },
  ...
  wave_850: { title: 'Wave 850 hPa (~1500m)', gradient: 'linear-gradient(to right, rgb(30,60,210), rgb(120,170,255), rgb(245,245,245), rgb(255,170,120), rgb(210,30,30))', labels: ['-3 m/s', '0 m/s', '+3 m/s'] },
  ...
  geopotential_950: { title: 'Geopotential 950 hPa', gradient: 'linear-gradient(to right, rgb(0,0,255), rgb(0,255,255), rgb(0,0,0), rgb(255,255,0), rgb(255,0,0), rgb(128,0,0))', labels: ['425 m', '575 m'] },
  geopotential_850: { title: 'Geopotential 850 hPa', gradient: 'linear-gradient(to right, rgb(0,0,255), rgb(0,255,255), rgb(0,0,0), rgb(255,255,0), rgb(255,0,0), rgb(128,0,0))', labels: ['1275 m', '1725 m'] },
  geopotential_700: { title: 'Geopotential 700 hPa', gradient: 'linear-gradient(to right, rgb(0,0,255), rgb(0,255,255), rgb(0,0,0), rgb(255,255,0), rgb(255,0,0), rgb(128,0,0))', labels: ['2550 m', '3450 m'] },
  geopotential_600: { title: 'Geopotential 600 hPa', gradient: 'linear-gradient(to right, rgb(0,0,255), rgb(0,255,255), rgb(0,0,0), rgb(255,255,0), rgb(255,0,0), rgb(128,0,0))', labels: ['3570 m', '4830 m'] },
  geopotential_500: { title: 'Geopotential 500 hPa', gradient: 'linear-gradient(to right, rgb(0,0,255), rgb(0,255,255), rgb(0,0,0), rgb(255,255,0), rgb(255,0,0), rgb(128,0,0))', labels: ['4760 m', '6440 m'] },
  geopotential_300: { title: 'Geopotential 300 hPa', gradient: 'linear-gradient(to right, rgb(0,0,255), rgb(0,255,255), rgb(0,0,0), rgb(255,255,0), rgb(255,0,0), rgb(128,0,0))', labels: ['7820 m', '10580 m'] },
...
const OVERLAY_META = {
  ...
  cloud_base_hourly_max: { label: 'Cloud base max (1h)', unit: 'm', integer: true },
  dry_conv_top: { label: 'Dry convection top', unit: 'm', integer: true },
  mh: { label: 'Boundary layer top', unit: 'm MSL', decimals: 1 },
  ...
  wave_850: { label: 'Wave 850', unit: 'm/s', decimals: 1 },
