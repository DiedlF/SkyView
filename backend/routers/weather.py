...
def build_weather_router(*, api_symbols, api_wind, api_emagram_point, api_meteogram_point):
    ...
    router.add_api_route("/api/meteogram_point", api_meteogram_point, methods=["GET"])
    return router
